    ...
    [
        ...
        },
        {
            ...
            {   
                ...
                messageB_opacity_in: [0, 1, { start: 0.6, end: 0.88 }],
                messageC_opacity_in: [0, 1, { start: 0.9, end: 0.95 }],
                messageA_translateY_out: [0, -20, { start: 0.3, end: 0.35 }],
                messageB_translateY_out: [0, -20, { start: 0.6, end: 0.88 }],
                messageC_translateY_out: [0, 80, { start: 0.9, end: 0.95 }],
                messageA_opacity_out: [1, 0, { start: 0.3, end: 0.35 }],
                messageB_opacity_out: [1, 0, { start: 0.68, end: 0.88 }],
